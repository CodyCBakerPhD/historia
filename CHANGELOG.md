...
- Bolded proper-name references to Historia in docs prose for consistency across the tutorial, installation page, docs landing page, and developer guide. ([#N](https://github.com/CodyCBakerPhD/historia/pull/N))
