...
- Added the Historia logo to the README and documentation landing page via the GitHub user-attachments CDN URL. ([#39](https://github.com/CodyCBakerPhD/historia/pull/39))
