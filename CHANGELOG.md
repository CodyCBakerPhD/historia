...
- Simplified CLI option names to dash-free forms (for example `--url` and `--enddateplaceholderdays`) while preserving snake_case keyword routing in command handlers. ([#46](https://github.com/CodyCBakerPhD/historia/pull/46))
