...
- Added Sphinx documentation scaffolding with the PyData theme, API autodocs, and Read the Docs configuration for hosted docs builds. ([#N](https://github.com/CodyCBakerPhD/historia/pull/N))
