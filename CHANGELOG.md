...
- Unpacked GitHub data update paths by promoting the CLI group to `historia update github` and exposing the API at `historia.github.update(...)`, and updated API docs autosummary entries so subgroup pages appear in the generated toctree. ([#0](https://github.com/CodyCBakerPhD/historia/pull/0))
