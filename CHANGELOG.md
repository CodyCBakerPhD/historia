...
- Renamed the root CLI function to `historia_cli` and exposed it at package root as `historia.historia_cli` for plugin integrations. ([#12](https://github.com/CodyCBakerPhD/historia/pull/12))
