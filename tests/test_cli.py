...
def test_project_populate_command_invokes_add_to_project(
    ...
    called_args: dict[str, pathlib.Path | str | int | dict[str, str] | None] = {}
    ...
    def _fake_add_to_project(
        ...
        extra_field_values: dict[str, str] | None,
    ) -> None:
        called_args["directory"] = directory
        ...
        called_args["extra_field_values"] = extra_field_values
    ...
    assert called_args["extra_field_values"] == {"Member": "Cody", "Type": "RaisedIssue"}
